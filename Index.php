...
<html>
    ...
    <body onload="carregar()">
        ...
        <a href="#top" class="back"> <img id="setaTop" style="border-radius: 100%; transform: translate(2px, 2px);" src="Imagens/seta/arrow2.png" width="64px" height="64px" name="arrow" alt="Seta para Cima" /> </a>
    </body>
</html>