...
$outHeadTable .= "\n\t\t<th style='background: #FFAA00; color: #000;'> Deletar </th>";
...
while ($lines = mysqli_fetch_assoc($resultSet)) {
    ...
    $outBodyTable .= "\n\t\t<td style='background: #000; color: #FFF;'> 
                        <form method='post' action='deleteVerific.php'> <input class='stelf' name='id' value='".$lines[$fieldsItems[0]]."'>
                            <input type='image' src='../Imagens/crud/x.png' style='width: 40px; height: 40px; background: transparent;' value='enviar'>
                        </form>
                      </td>";
    $outBodyTable .= "\n\t</tr>";
}
