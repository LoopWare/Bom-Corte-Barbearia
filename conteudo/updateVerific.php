...
if (!$_POST) {
    ...
    $horario = $_POST["hora"];
    $idTipoUsuario = $linha2["idUsuario"];
    ...
    $agendamento0 = new Agendamento($id, $nome, $cpf, $data, $idCorte, $barbeiro, $descricao, $horario, $idTipoUsuario);
}
            ...
            <div class="cad">
            	...
            	if($horario != "ℬℭ"){
            	    if($agendamento0->save()){
            	        echo "<label id='msgRec' aria-hidden='true'> Atualização realizada com sucesso </label>";
            	    }else {
            	        echo "<label id='msgRec' aria-hidden='true'> Falha ao realizar a Atualização, tente novamente! </label>";
            	    }
            	} else {
            	    echo "<label id='msgRec' aria-hidden='true'> Falha ao realizar a Atualização, tente novamente! </label>";
            	}
                ?>
                <a href="update.php"><img id="seta" src="../Imagens/seta/arrow.png" Alt="Seta para voltar" title="Seta para voltar"></a>
            </div>
